...
module.exports.getPluto = function Pluto() {
    const pluto = {
        image: 'https://upload.wikimedia.org/wikipedia/commons/thumb/c/ca/Pluto_in_True_Color_-_High-Res.png/1024px-Pluto_in_True_Color_-_High-Res.png',
...
module.exports.getMeteorite = function Meteorites() {
    const meteorites = {
        ...
        description: 'When meteoroids enter Earth’s atmosphere (or that of another planet, like Mars) at high speed and burn up, the fireballs or “shooting stars.” When a meteoroid survives a trip through the atmosphere and hits the ground. Several meteors per hour can usually be seen on any given night. When there are lots more meteors',
